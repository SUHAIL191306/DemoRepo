...
<legend> Update Customer </legend>
    <form method="post" action="/edit">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{$data['cusName']}}" id="name" required />
            <span> * Name is a required Field </span>
        </div>
        <div>
            <label> Location </label>
            <input type="text" style="margin-left:17px;" value="{{$data['cusLocation']}}" name="location" id="location" required />
            <span> * Location is a required Field </span>
        </div>
        <div>
            <label> Your Email </label>
            <input type="email" name="email" value="{{$data['cusEmail']}}" id="email" required />
